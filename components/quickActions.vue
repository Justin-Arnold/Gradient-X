...
<template>
    <div class="rounded-lg bg-neutral-50 dark:bg-slate-900 p-4 w-full shadow-md">
        <div class=" dark:text-slate-50">Quick Actions</div>
        <div class=" h-24 rounded-lg  flex gap-2">
            <ModalButton>
